...
namespace Brighid.Commands.Artifacts
{
    ...
    public class ArtifactsStack : Stack
    {
        ...
        private void AddRepository()
        {
            ...
            {
                RepositoryName = "brighid/commands",
            ...
            _ = new CfnOutput(this, "ImageRepositoryUri", new CfnOutputProps
            {
                ...
                Description = "URI of the container image repository for Brighid Commands.",
            });
        }
        ...
        private void AddDns()
        {
            _ = new CfnRecordSetGroup(this, "DevDnsRecords", new CfnRecordSetGroupProps
            {
                ...
                RecordSets = new[]
                {
                    CreateDnsAliasRecord("commands.dev.brigh.id", "A"),
                    CreateDnsAliasRecord("commands.dev.brigh.id", "AAAA"),
                },
            });
            ...
            _ = new CfnRecordSetGroup(this, "ProdDnsRecords", new CfnRecordSetGroupProps
            {
                ...
                RecordSets = new[]
                {
                    CreateDnsAliasRecord("commands.brigh.id", "A"),
                    CreateDnsAliasRecord("commands.brigh.id", "AAAA"),
                },
            });
        }
    }
